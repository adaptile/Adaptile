...
const TEAM = [
  ...
  { name: 'Hussien', role: 'Developer', photo: '/hussienpfp.jpg', bio: 'Software engineer with 5+ years of experience specializing in high-performance web applications, bridging the gap between robust system architecture and intuitive user experiences. Expertise spans the entire stack — from crafting semantic, accessible interfaces with HTML5 and React to building complex backend services in Python, Java, and C++. Focused on scalable, SQL-driven data models that power seamless digital products.' },
  { name: 'Julian', role: 'Senior Illustrator', photo: '/sampfp.jpg', bio: 'Versatile visual artist with 10+ years of experience rooted in tattoo artistry and traditional illustration. Brings a rare hand-drawn precision to digital brand work, translating intricate linework and compositional instinct into bold, memorable visuals. Fluent across all major digital creation platforms including Photoshop, Illustrator, Procreate, Clip Studio Paint, and After Effects. Delivers custom illustrations, character concepts, brand identity artwork, and bespoke design assets that carry a distinct, handcrafted edge.' },
