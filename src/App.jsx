...
const TEAM = [
  ...
  { name: 'Julian', role: 'Artist', bio: 'Creating original visual concepts and illustrations that define brand character.' },
  { name: 'Finn', role: 'Artist', bio: 'Designing striking artwork and brand assets that captivate and convert.' },
  { name: 'Josh', role: 'Motion Designer', bio: 'Bringing brands to life through animation, motion graphics, and dynamic visual storytelling.' },
  ...
  { name: 'Issy', role: 'Project Manager', bio: 'Orchestrating timelines, teams, and deliverables to ensure every project launches flawlessly.' },
