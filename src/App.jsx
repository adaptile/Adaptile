...
const TEAM = [
  ...
  { name: 'Julian', role: 'Artist', photo: '/julianpfp.jpg', bio: 'Creating original visual concepts and illustrations that define brand character.' },
  { name: 'Finn', role: 'Artist', photo: '/sampfp.jpg', bio: 'Designing striking artwork and brand assets that captivate and convert.' },
  { name: 'Josh', role: 'Motion Designer', photo: '/joshpfp.jpg', bio: 'Bringing brands to life through animation, motion graphics, and dynamic visual storytelling.' },
