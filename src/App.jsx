...
/* ─────────────────────────────────────
   ...
   ───────────────────────────────────── */
const TEAM = [
  { name: 'Yezen', role: 'Founder & Creative Director', bio: 'Visionary leader driving brand strategy and creative excellence across all projects.' },
  ...
  { name: 'Biellal', role: 'Marketing Director', photo: '/biellal-pfp.jpg', bio: 'Developing data-driven strategies that amplify reach and drive market dominance.' },
  { name: 'Issy', role: 'Project Manager', photo: '/issypfp.jpg', bio: 'Orchestrating timelines, teams, and deliverables to ensure every project launches flawlessly.' },
  { name: 'Ryan', role: 'Data Analyst', photo: '/ryan-pfp.jpg', bio: 'Data analyst with strong SQL and data analytics fundamentals, experienced in transforming raw data into actionable business insights. Skilled in writing complex queries using CTEs, window functions, and aggregations to solve problems in revenue analysis, customer analytics, and retention. Built and documented multiple end-to-end data analytics projects covering data transformation, data quality validation, and business intelligence reporting.' },
]
